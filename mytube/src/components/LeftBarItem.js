...
const LeftBarItem = ({item}) => {
  ...
  return (
    <>
        <div
            className={`${!isLeftBarOpen ? 'items-center flex-col cursor-pointer hover:bg-slate-100' : 'font-bold flex-row items-center w-full border border-b-0 border-t-1 border-r-0'} flex px-2 py-2`}
